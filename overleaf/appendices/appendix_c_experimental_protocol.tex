...
\paragraph{Compute.}
The independent verification used Python 3.12.13 and NumPy 2.3.5 on Linux 6.18.35, an AMD EPYC 9V74 allocation with 9 logical CPUs and 21~GiB RAM. The complete 32-instance locked rerun took 27.64 seconds wall-clock and no GPU. The archived manifest records Python 3.13.5 and NumPy 2.3.5 but not original CPU or wall time; this missing historical metadata is disclosed rather than reconstructed.
